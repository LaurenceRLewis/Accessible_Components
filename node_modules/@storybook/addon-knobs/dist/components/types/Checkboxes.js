...
var CheckboxesType = /*#__PURE__*/function (_Component) {
  ...
  function CheckboxesType(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderCheckboxList", function (_ref2) {
      var options = _ref2.options;
      return Object.keys(options).map(function (key) {
        return _this.renderCheckbox(key, options[key]);
      });
    });
    _defineProperty(_assertThisInitialized(_this), "renderCheckbox", function (label, value) {
