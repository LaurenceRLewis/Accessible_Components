...
`);return import_ts_dedent30.default`
    ...
    To learn more about this change, see: ${import_chalk27.default.yellow("https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#mdx-docs-files")}
  `},async run({dryRun,mainConfigPath,result:{nextStoriesEntries}}){logger22.info(import_ts_dedent30.default`✅ Setting 'stories' config:
...
`)}
            `.trim(),{borderStyle:"round",padding:1,borderColor:"#F1618C"})),process.exit(1)),choices.length===1?[selectedTemplate]=choices:(logger26.info((0,import_boxen3.default)(import_ts_dedent31.dedent`
...
yarn storybook`):`Recreate your setup, then ${import_chalk28.default.yellow("npx storybook@latest init")}`;logger26.info((0,import_boxen3.default)(import_ts_dedent31.dedent`
