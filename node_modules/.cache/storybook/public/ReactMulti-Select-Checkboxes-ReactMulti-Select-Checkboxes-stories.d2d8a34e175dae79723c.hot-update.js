...
const ReactMultiSelectCheckboxes = ({
  ...
  const updateCheckCount = event => {
    ...
    (0,_ariaAnnounce__WEBPACK_IMPORTED_MODULE_3__["default"])(`${checkCount} of ${totalCheckboxes} checkboxes checked`);
  };
  const onKeyDown = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(event => {
    (0,_keyboardNavigation__WEBPACK_IMPORTED_MODULE_4__["default"])(event, checkboxesRef.current, updateCheckCount, isAlternativeSelectionModel);
...
//# sourceMappingURL=ReactMulti-Select-Checkboxes-ReactMulti-Select-Checkboxes-stories.d2d8a34e175dae79723c.hot-update.js.map