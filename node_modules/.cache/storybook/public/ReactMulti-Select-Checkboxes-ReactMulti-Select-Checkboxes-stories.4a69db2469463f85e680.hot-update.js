...
const ReactMultiSelectCheckboxes = () => {
  ...
  const updateCheckCount = event => {
    const newCheckCount = event.target.checked ? checkCount + 1 : checkCount - 1;
    setCheckCount(newCheckCount);
    (0,_ariaAnnounce__WEBPACK_IMPORTED_MODULE_3__["default"])(`${newCheckCount} of ${totalCheckboxes} checkboxes checked`);
  };
  const onKeyDown = event => {
    (0,_keyboardNavigation__WEBPACK_IMPORTED_MODULE_4__.handleKeyboardNavigation)(event, checkboxesRef.current);
  };
...
/***/ "./stories/ReactMulti-Select-Checkboxes/keyboardNavigation.js":
/*!********************************************************************!*\
  !*** ./stories/ReactMulti-Select-Checkboxes/keyboardNavigation.js ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
const handleKeyboardNavigation = (event, checkboxes) => {
  const {
    key
  } = event;
...
//# sourceMappingURL=ReactMulti-Select-Checkboxes-ReactMulti-Select-Checkboxes-stories.4a69db2469463f85e680.hot-update.js.map